  ...
  en: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        'My path into web development started with three years of studying front-end. Over time, I became just as interested in how a website feels - backend as in how it works - design.',
    ...
    work: {
      ...
      grifone: {
        ...
        caseStudy: {
          ...
          location: 'GROSSETO, ITALY · 2026',
          imageAlt: 'Green classic Porsche in Piazza Dante, Grosseto',
          imageCaption: 'PIAZZA DANTE · GROSSETO',
          primaryStatement: ['A REAL SERVICE.', 'A CLEAR DIGITAL EXPERIENCE.'],
          secondaryStatement: ['BUILT FOR A CLIENT.', 'MADE FOR BUSINESS.'],
          summary:
            'Pratiche Auto Grifone is a local automotive services agency in Grosseto, Italy. The goal was to turn a complex, document-heavy service into a clear digital experience while preserving the personality of the business.',
          meta: {
            role: 'DESIGN + DEVELOPMENT',
            stack: 'REACT · JAVASCRIPT · PHP',
          },
          challenge: {
            marker: '02 / THE CHALLENGE',
            direction: 'FROM COMPLEXITY TO CLARITY',
            title: ['FROM', 'COMPLEXITY', 'TO', 'CLARITY.'],
            services: [
              'PASSAGGIO DI PROPRIETÀ',
              'NAZIONALIZZAZIONE VEICOLI',
              'PRENOTAZIONI REVISIONE / COLLAUDI',
              'RINNOVO PATENTE',
              'IMMATRICOLAZIONE',
              'REIMMATRICOLAZIONE',
              'VISURA PRA',
              'RADIAZIONE',
              'DUPLICATO',
              'PRATICHE MOTO E CICLOMOTORI',
              'ALTRO',
            ],
            problem: {
              label: 'THE PROBLEM',
              lines: ['Many services. Different requirements.', 'Document-heavy processes.'],
            },
            goal: {
              label: 'THE GOAL',
              lines: ['Make every service easier to understand,', 'navigate and act on.'],
            },
            statement: 'ONE SERVICE → ONE CLEAR NEXT STEP',
          },
          structure: {
            marker: '03 / THE STRUCTURE',
            direction: 'DESIGNED AROUND REAL TASKS',
            ...
            steps: [
              { title: 'WHAT DO YOU NEED?' },
              {
                ...
                detail: {
                  label: 'SERVICE',
                  value: 'PASSAGGIO DI PROPRIETÀ · RINNOVO PATENTE · IMMATRICOLAZIONE',
                },
              },
              {
                ...
                detail: {
                  label: 'DOCUMENTS',
                  value: 'WHAT TO BRING · WHAT IS REQUIRED',
                },
              },
              {
                title: 'TAKE ACTION',
                detail: {
                  label: 'ACTION',
                  value: 'CONTACT · WHATSAPP · SEND DOCUMENTS',
                },
              },
            ],
            statement: {
              lead: 'Instead of asking users to understand the bureaucracy, the website guides them from their need to the',
              emphasis: 'NEXT USEFUL ACTION.',
            },
          },
          experience: {
            marker: '04 / THE EXPERIENCE',
            direction: 'FROM STRUCTURE TO INTERFACE',
            title: ['DESIGNED TO', 'KEEP THINGS MOVING.'],
            labels: ['01 / DISCOVER', '02 / PREPARE', '03 / SEND', '04 / CONTACT'],
            local: ['STILL HUMAN.', 'STILL LOCAL.'],
            closing: ['ONE EXPERIENCE.', 'FROM FIRST QUESTION TO DIRECT ACTION.'],
            alts: {
              hero: 'Pratiche Auto Grifone homepage with the green Porsche in Piazza Dante',
              documents: 'Documenti necessari service list on the Pratiche Auto Grifone website',
              send: 'Invia documenti call to action on the Pratiche Auto Grifone website',
              contact: 'Contact information and local office section on the Pratiche Auto Grifone website',
            },
          },
          workflow: {
            marker: '05 / THE WORKFLOW',
            direction: 'BUILT FOR REAL USE',
            ...
            interfaceTitle: 'Live Pratiche Auto Grifone document submission interface',
            interfaceCaption: 'LIVE INTERFACE · /INVIA-DOCUMENTI',
            technical: [
              { label: 'SERVICE PRESELECTED', value: '?pratica=...' },
              { label: 'FILES', value: 'ADD · REVIEW · REMOVE' },
              { label: 'FEEDBACK', value: 'SUBMITTING · SUCCESS · ERROR' },
            ],
            closing: ['NOT JUST A CONTACT FORM.', 'A GUIDED WORKFLOW.'],
          },
          build: {
            marker: '06 / THE BUILD',
            direction: 'DESIGNED. DEVELOPED. DELIVERED.',
            title: ['BUILT TO WORK.', 'NOT JUST TO LOOK GOOD.'],
            decisions: [
              {
                key: 'context',
                label: 'CONTEXT',
                title: 'SERVICE → URL → FORM',
                codeLabel: 'URL search parameter and service allowlist code',
                supporting:
                  'The selected service follows the user into the document workflow without asking them to choose twice.',
              },
              {
                key: 'files',
                label: 'FILES',
                title: 'VALIDATE BEFORE UPLOAD',
                codeLabel: 'File validation limits and allowed formats code',
                factsLabel: 'File validation limits',
                facts: ['PDF · JPG · JPEG · PNG', 'MAX 6 FILES', '8 MB / FILE', '25 MB TOTAL'],
              },
              {
                key: 'states',
                label: 'STATES',
                title: 'THE INTERFACE RESPONDS.',
                codeLabel: 'Request and response status handling code',
                factsLabel: 'Interface states',
                facts: [
                  'IDLE · DRAGGING · SUBMITTING',
                  'SUCCESS · ERROR · RATE-LIMITED',
                ],
              },
            ],
            closing: ['DESIGN IS WHAT USERS SEE.', 'LOGIC IS WHAT MAKES IT WORK.'],
          },
          underHood: {
            marker: '07 / UNDER THE HOOD',
            direction: 'FROM SUBMIT TO RESPONSE',
            title: ['WHAT HAPPENS', 'AFTER SEND?'],
            principle: ['THE SERVER CHECKS AGAIN.', 'CLIENT VALIDATION ≠ TRUST'],
            flowLabel: 'Submission flow from React form to interface response',
            flow: [
              { title: 'REACT', detail: 'FORM + FILES' },
              { title: 'FORMDATA', detail: 'MULTIPART POST' },
              { title: 'PHP', detail: 'SERVER ENDPOINT' },
              { title: 'VALIDATE', detail: 'MIME + LIMITS' },
              { title: 'EMAIL', detail: 'MAIL + ATTACHMENTS' },
              { title: 'CLEANUP', detail: 'TEMP FILES REMOVED' },
              { title: 'RESPONSE', detail: 'JSON → UI STATE' },
            ],
            codeLabel: 'REAL PHP · MIME VALIDATION',
            codeDescription: 'PHP MIME validation excerpt from send-documents.php',
            temporary: {
              label: 'PRIVATE TEMP FILES',
              permissions: ['0700 DIRECTORY', '0600 FILES'],
              cleanup: '→ ALWAYS CLEANED UP',
            },
  ...
  it: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        'Il mio percorso nello sviluppo web è iniziato con tre anni di studio del front-end. Con il tempo, mi sono interessata tanto a come un sito fa sentire le persone - backend quanto a come funziona - design.',
    ...
    work: {
      ...
      grifone: {
        ...
        caseStudy: {
          marker: '01 / IL PROGETTO',
          location: 'GROSSETO, ITALIA · 2026',
          imageAlt: 'Porsche classica verde in Piazza Dante a Grosseto',
          imageCaption: 'PIAZZA DANTE · GROSSETO',
          primaryStatement: ['UN SERVIZIO REALE.', 'UN’ESPERIENZA DIGITALE CHIARA.'],
          secondaryStatement: ['CREATO PER UN CLIENTE.', 'PENSATO PER IL BUSINESS.'],
          summary:
            'Pratiche Auto Grifone è un’agenzia locale di servizi automobilistici a Grosseto, Italia. L’obiettivo era trasformare un servizio complesso e ricco di documenti in un’esperienza digitale chiara, preservando al tempo stesso la personalità dell’attività.',
          meta: {
          ...
          challenge: {
            marker: '02 / LA SFIDA',
            direction: 'DALLA COMPLESSITÀ ALLA CHIAREZZA',
            title: ['DALLA', 'COMPLESSITÀ', 'ALLA', 'CHIAREZZA.'],
            services: [
              'PASSAGGIO DI PROPRIETÀ',
              'NAZIONALIZZAZIONE VEICOLI',
              'PRENOTAZIONI REVISIONE / COLLAUDI',
            ...
            problem: {
              label: 'IL PROBLEMA',
              lines: ['Molti servizi. Requisiti diversi.', 'Procedure ricche di documenti.'],
            },
            goal: {
              label: 'L’OBIETTIVO',
              lines: ['Rendere ogni servizio più facile da capire,', 'navigare e avviare.'],
            },
            statement: 'UN SERVIZIO → UN PROSSIMO PASSO CHIARO',
          },
          structure: {
            marker: '03 / LA STRUTTURA',
            direction: 'PROGETTATO INTORNO A COMPITI REALI',
            title: ['PARTI DA', 'CIÒ CHE TI SERVE.'],
            steps: [
              ...
              {
                title: 'CONTROLLA I DOCUMENTI',
                detail: {
                  label: 'DOCUMENTI',
                  value: 'COSA PORTARE · COSA È RICHIESTO',
                },
              },
              {
                ...
                detail: {
                  label: 'AZIONE',
                  value: 'CONTATTO · WHATSAPP · INVIA DOCUMENTI',
                },
              },
            ],
            statement: {
              lead: 'Invece di chiedere agli utenti di comprendere la burocrazia, il sito li guida dalla loro esigenza alla',
              emphasis: 'PROSSIMA AZIONE UTILE.',
            },
          },
          experience: {
            marker: '04 / L’ESPERIENZA',
            direction: 'DALLA STRUTTURA ALL’INTERFACCIA',
            title: ['PROGETTATO PER', 'MANTENERE TUTTO IN MOVIMENTO.'],
            labels: ['01 / SCOPRI', '02 / PREPARA', '03 / INVIA', '04 / CONTATTA'],
            local: ['ANCORA UMANO.', 'ANCORA LOCALE.'],
            closing: ['UN’UNICA ESPERIENZA.', 'DALLA PRIMA DOMANDA ALL’AZIONE DIRETTA.'],
            alts: {
              hero: 'Homepage di Pratiche Auto Grifone con la Porsche verde in Piazza Dante',
              documents: 'Elenco Documenti necessari sul sito di Pratiche Auto Grifone',
              send: 'Invito a inviare i documenti sul sito di Pratiche Auto Grifone',
              contact: 'Contatti e sede locale sul sito di Pratiche Auto Grifone',
            },
          },
          workflow: {
            marker: '05 / IL FLUSSO',
            direction: 'CREATO PER L’USO REALE',
            title: ['DALL’INFORMAZIONE', 'ALL’AZIONE.'],
            steps: [
              'SCEGLI UN SERVIZIO',
            ...
            interfaceTitle: 'Interfaccia reale di invio documenti di Pratiche Auto Grifone',
            interfaceCaption: 'INTERFACCIA REALE · /INVIA-DOCUMENTI',
            technical: [
              { label: 'SERVIZIO PRESELEZIONATO', value: '?pratica=...' },
              { label: 'FILE', value: 'AGGIUNGI · CONTROLLA · RIMUOVI' },
              { label: 'FEEDBACK', value: 'INVIO · SUCCESSO · ERRORE' },
            ],
            closing: ['NON SOLO UN MODULO DI CONTATTO.', 'UN FLUSSO GUIDATO.'],
          },
          build: {
            marker: '06 / LO SVILUPPO',
            direction: 'PROGETTATO. SVILUPPATO. CONSEGNATO.',
            title: ['CREATO PER FUNZIONARE.', 'NON SOLO PER ESSERE BELLO.'],
            decisions: [
              {
                key: 'context',
                label: 'CONTESTO',
                title: 'SERVIZIO → URL → MODULO',
                codeLabel: 'Codice del parametro URL e della allowlist dei servizi',
                supporting:
                  'Il servizio selezionato accompagna l’utente nel flusso documenti, senza chiedergli di scegliere due volte.',
              },
              {
                key: 'files',
                label: 'FILE',
                title: 'VALIDA PRIMA DEL CARICAMENTO',
                codeLabel: 'Codice dei limiti e dei formati file consentiti',
                factsLabel: 'Limiti di validazione dei file',
                facts: ['PDF · JPG · JPEG · PNG', 'MAX 6 FILE', '8 MB / FILE', '25 MB TOTALI'],
              },
              {
                key: 'states',
                label: 'STATI',
                title: 'L’INTERFACCIA RISPONDE.',
                codeLabel: 'Codice di gestione degli stati della richiesta e della risposta',
                factsLabel: 'Stati dell’interfaccia',
                facts: [
                  'IDLE · DRAGGING · SUBMITTING',
                  'SUCCESS · ERROR · RATE-LIMITED',
                ],
            ...
            closing: ['IL DESIGN È CIÒ CHE GLI UTENTI VEDONO.', 'LA LOGICA È CIÒ CHE LO FA FUNZIONARE.'],
          },
          underHood: {
            marker: '07 / SOTTO IL COFANO',
            direction: 'DALL’INVIO ALLA RISPOSTA',
            title: ['COSA SUCCEDE', 'DOPO L’INVIO?'],
            principle: ['IL SERVER CONTROLLA DI NUOVO.', 'VALIDAZIONE CLIENT ≠ FIDUCIA'],
            flowLabel: 'Flusso di invio dal modulo React alla risposta dell’interfaccia',
            flow: [
              { title: 'REACT', detail: 'MODULO + FILE' },
              { title: 'FORMDATA', detail: 'POST MULTIPART' },
              { title: 'PHP', detail: 'ENDPOINT SERVER' },
              { title: 'VALIDA', detail: 'MIME + LIMITI' },
              { title: 'EMAIL', detail: 'MAIL + ALLEGATI' },
              { title: 'PULIZIA', detail: 'FILE TEMPORANEI RIMOSSI' },
              { title: 'RISPOSTA', detail: 'JSON → STATO UI' },
            ],
            codeLabel: 'PHP REALE · VALIDAZIONE MIME',
            codeDescription: 'Estratto PHP della validazione MIME da send-documents.php',
            temporary: {
              label: 'FILE TEMPORANEI PRIVATI',
